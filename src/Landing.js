					...
					<div id="geo-slides" className="carousel slide" data-ride="carousel">
						...
						<div className="carousel-inner">
							<div class="carousel-item active">
								<img src="assets/img/slider.png" alt="First slide" />
							...
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Second slide" />
								<h3>Preview geospatial data resources</h3>
								<p>Discover and view mapped data maintained on web-accessible maps (live maps) without launching a map viewer.</p>
							</div>
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Third slide" />
							...
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Fourth slide" />
								<h3>Compare, print and download geospatial data resources</h3>
								<p>You can compare existing data and download the comparison in CSV, PDF or JPEG format.</p>
							</div>
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Fifth slide" />
								<h3>Data Analysis</h3>
							...
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Sixth slide" />
							...
							<div className="carousel-item">
								<img src="assets/img/slider.png" alt="Seventh slide" />
								<h3>Add primitive spatial objects</h3>
								<p>You can add spatial objects including points, lines and polygons to the geoportal.</p>
							</div>
						</div>
